    ...
    .sendEmail({
      Content: {
        Simple: {
          ...
          Body: {
            Text: {
              Data: `다음 링크를 눌러 비밀번호를 초기화합니다. http://${HOST}/reset-password?code=${passwordResetCode}`,
              Charset: 'UTF-8',
            },
          },
        },
      ...
      FromEmailAddress: 'noreply@host.com',
    })
    .promise()
    ...
    .sendEmail({
      Content: {
        Simple: {
          ...
          Body: {
            Text: {
              Data: `다음 링크를 눌러 이메일 인증을 진행해주세요. http://${HOST}/verify-email?code=${emailVerificationCode}`,
              Charset: 'UTF-8',
            },
          },
        },
